...
from legacy.original_scripts.new import process_query_results2, connect_to_neo4j, execute_query, process_query_results
from legacy.original_scripts.pattern2blocks import parse_filtered_pattern, generate_blocks
from legacy.original_scripts.PPS import (
...
def run_local(args):
    from legacy.original_scripts.gaplink_local import run
...
def process_and_save_results(filtered_output_file, iteration, matched_pairs, start_time):
    ...
    ground_truth_path = 'dataset/fodors_zagats/ground_truth_fodors_zagats.txt'
