...
PROMPT_VERSION = "v11-stable-small-paper-guidance"
...
class DatasetConfig:
    ...
    stage2_accept_confidence_small: float | None = None
    stage2_accept_confidence_large: float | None = None
    prompt_version: str = PROMPT_VERSION
    stage2_accept_any_rules: tuple[str, ...] = ()
    stage1_allowed_rules: tuple[str, ...] = ()
    author_block_max_size: int = 250
    use_author_context_blocks: bool = True
...
DATASET_CONFIGS = {
    ...
    "dblp_acm": DatasetConfig(
        ...
        stage2_accept_confidence_small=0.0,
        stage2_accept_confidence_large=0.95,
    ),
    "dblp_scholar": DatasetConfig(
        key="dblp_scholar",
        display_name="DBLP-Scholar",
        task_name="DBLP-Scholar publication ER",
        entity_noun="paper",
        graph_kind="paper_author_venue",
        network_dir=Path("dataset/dblp_scholar/network"),
        entity_label="Paper",
        address_label="Author",
        city_label="Venue",
        located_rel="WRITTEN_BY",
        ...
        left_id_max_exclusive=2616,
        right_id_min_inclusive=2616,
        truth_path=Path("dataset/dblp_scholar/network/ground_truth_dblp_scholar.txt"),
        table_b_offset=None,
        cache_prefix="dblp_scholar_threshold",
        rules_path=Path("rules/fz.txt"),
        stage2_accept_confidence=0.95,
        stage2_accept_confidence_small=0.0,
        stage2_accept_confidence_large=0.95,
    ...
    "amazon_google": DatasetConfig(
        ...
        prompt_version="v9-ag-product-title-context",
        stage2_accept_any_rules=(),
        stage1_allowed_rules=("name045_phone_area", "author_name060_context075"),
    ),
    ...
    "arxiv": DatasetConfig(
        ...
        rules_path=Path("rules/fz.txt"),
        stage2_accept_confidence=0.8,
        stage2_accept_confidence_small=0.8,
        stage2_accept_confidence_large=0.8,
        prompt_version="v9-arxiv-author-records",
        stage2_accept_any_rules=(),
        stage1_allowed_rules=("name_or_cuisine_or_char060",),
    ),
}
